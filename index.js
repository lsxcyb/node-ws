...
const UUID = process.env.UUID || 'cb438530-cf8c-4197-888d-310d118ce8ea'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'nxzd';            // 获取节点的订阅路径
const NAME = process.env.NAME || 'hapda';                       // 节点名称
